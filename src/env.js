...
export const env = createEnv({
  ...
  server: {
    ...
    TELEGRAM_INITDATA_TTL_SEC: z.coerce.number().int().min(60).max(3600).default(900),
    TELEGRAM_INITDATA_SKEW_SEC: z.coerce.number().int().min(0).max(300).default(30),
  ...
  runtimeEnv: {
    ...
    TELEGRAM_INITDATA_TTL_SEC: process.env.TELEGRAM_INITDATA_TTL_SEC,
    TELEGRAM_INITDATA_SKEW_SEC: process.env.TELEGRAM_INITDATA_SKEW_SEC,
